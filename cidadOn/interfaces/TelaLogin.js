		...
		return (
			<ScrollView>
					<View
						...
						<Text style={{ fontSize: 20, color: '#000000' }}>Bem vindo ao CidadOn!</Text>
						<Text style={{ fontSize: 20, textAlign: 'center', color: '#000000' }}>Já possui uma conta? Faça seu login e continue colaborando com sua cidade!</Text>
						...
						<View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20 }}>
							<Text style={{ fontSize: 20, marginTop: 30, color: '#000000' }}>Ainda não é um CidadOn?</Text>
							<Text style={{ fontSize: 20, marginTop: 20, color: '#000000' }}>cadastre-se já!</Text>
							<Botao texto='Cadastrar' onPress={() => { Actions.TelaCadastroUsuario() }} />
						</View>
				</View>
			</ScrollView >
		);
