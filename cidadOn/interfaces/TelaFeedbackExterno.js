...
import {colors,styles} from '../layout'


class TelaFeedBackExterno extends React.Component {
	constructor(props) {
		super(props);
			...
			<View>
				<View>
					...
					<View style={{ marginTop: 10, justifyContent: 'center', alignItems: 'center' }}>
						<Text style={{ fontSize: 20, color: colors.preto }}>E-mail</Text>
						
						<TextInput maxLength={200}  style={styles.textInput  } placeholder="e-mail" onChangeText={texto => this.props.modificaDescricao(texto)} />
					</View>
					...
					<View style={{ marginTop: 10, justifyContent: 'center', alignItems: 'center' }}>
						...
						<TextInput value={this.props.descricao} maxLength={200} multiline={true}  style={styles1.entrada} placeholder="descrição" onChangeText={texto => this.props.modificaDescricao(texto)} />
					<View style={styles1.botao}>
