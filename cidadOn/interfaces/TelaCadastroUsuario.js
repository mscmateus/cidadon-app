			...
			<ScrollView>
				<View style={{ padding: 20 }}>
					<View style={{ marginTop: 30, justifyContent: 'center', alignItems: 'center' }}>
						...
						<TextInput value={this.props.nomeUsuario} style={styles.textInput} maxLength={50} placeholder="Nome de usuário" onChangeText={texto => this.props.modificaNomeUsuario(texto)} />
						...
						<Text style={styles.textoInformacaoValidacao} >No mínimo 6 caracteres e no máximo 10.</Text>
