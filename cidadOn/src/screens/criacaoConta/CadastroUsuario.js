...
constructor(props){
	...
	validaEmail(){
		if(this.props.email==''){
			...
			return false;
		}else if(this.props.email.indexOf("@")==-1 || this.props.email.indexOf(".com") == -1 || this.props.email.indexOf("@") == this.props.email.indexOf(".com")-1 || this.props.email.indexOf("@") > this.props.email.indexOf(".com")){
